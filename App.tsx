      ...
      <main className="flex-1 overflow-y-auto no-scrollbar p-6 pb-32">
        {activeTab === 'home' ? (
          <div className="grid grid-cols-1 gap-5">
            {repos.length === 0 ? (
              <div className="text-center py-20 animate-in fade-in duration-500">
                <div className="w-24 h-24 bg-slate-100 dark:bg-slate-900 rounded-[2.5rem] mx-auto mb-8 flex items-center justify-center border border-light-border dark:border-dark-border">
                ...
                <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-2 tracking-tight">Vault Empty</h2>
                <p className="text-sm text-slate-400 font-medium px-8 leading-relaxed">Your future projects await. Add any GitHub link to get started.</p>
              </div>
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className="bg-light-card dark:bg-dark-card border border-light-border dark:border-dark-border rounded-[2.5rem] p-8 shadow-sm">
              ...
              <textarea 
                ...
                placeholder="What project should I try out today?"
                value={vibe}
              ...
              <button 
                ...
                className="w-full mt-6 bg-primary text-white font-extrabold py-5 rounded-2xl shadow-lg shadow-primary/20 active:scale-95 transition-all disabled:opacity-50"
              >
            ...
            {recommendation && (
              <div className="space-y-4 animate-in zoom-in duration-300">
                <div className="bg-primary/5 dark:bg-primary/10 border border-primary/20 p-6 rounded-[2rem]">
                  <p className="text-primary text-[10px] font-black uppercase tracking-[0.2em] mb-3">AI Pick</p>
